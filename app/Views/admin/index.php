                  ...
                  <div class="d-flex justify-content-center justify-content-md-end">
                    <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                        <a class="dropdown-item" href="<?= base_url() ?>#">January - March</a>
                        <a class="dropdown-item" href="<?= base_url() ?>#">March - June</a>
                        <a class="dropdown-item" href="<?= base_url() ?>#">June - August</a>
                        <a class="dropdown-item" href="<?= base_url() ?>#">August - November</a>
                      </div>
                    </div>
