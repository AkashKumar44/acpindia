  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="text-black" href="<?= base_url('http://localhost:8080/admin') ?>"><h3>Logo</h3></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('http://localhost:8080/admin') ?>">
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url() ?>">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url() ?>">Typography</a></li>
              </ul>
            </div>
          </li> -->
        </ul>
